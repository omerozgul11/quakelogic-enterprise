...
import {
    LayoutDashboard, Receipt, Tags, RefreshCw, BarChart3, Plug, Bell, LogOut, Menu, X, Sun, Moon, ChevronDown, Settings, ShieldCheck,
} from 'lucide-react';
...
const navItems: NavItem[] = [
    { label: 'Dashboard', href: '/expenses', icon: LayoutDashboard },
...
function isActive(path: string, href: string): boolean {
    if (href === '/expenses') return path === '/expenses';
...
export function ExpenseLayout({ children }: { children: React.ReactNode }) {
        ...
        <div className="ql-liquid flex min-h-screen">
            ...
            <div className="flex min-w-0 flex-1 flex-col">
                ...
                <footer className="py-4 text-center text-xs text-muted-foreground">
                    QuakeLogic Expenses — © {new Date().getFullYear()} QuakeLogic Inc.
                </footer>
            </div>
        </div>
    );
