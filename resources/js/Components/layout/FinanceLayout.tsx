...
import {
    LayoutDashboard, ReceiptText, FileMinus, Landmark,
...
const navItems: NavItem[] = [
    ...
    { label: 'Invoices', href: '/finance/invoices', icon: ReceiptText },
        ...
        <div className="flex h-full flex-col">
            ...
            <div className="px-4 pb-1 pt-2">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-primary/10 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-primary">
                    <Landmark className="h-3.5 w-3.5" /> Finance
                </span>
            </div>
        ...
        <div className="ql-liquid flex min-h-screen">
            ...
            <div className="flex min-w-0 flex-1 flex-col">
                ...
                <footer className="py-4 text-center text-xs text-muted-foreground">
                    QuakeLogic Finance — © {new Date().getFullYear()} QuakeLogic Inc.
                </footer>
            </div>
        </div>
    );
